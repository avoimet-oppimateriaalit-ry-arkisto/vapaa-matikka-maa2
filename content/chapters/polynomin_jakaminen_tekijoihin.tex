...
<<<<<<< HEAD
 ...
 \begin{alakohdat}
    	\alakohta{juurien käänteisarvot}
        \alakohta{juurien neliöiden käänteisarvot}
    \end{alakohdat}
    \begin{vastaus}
        \begin{alakohdat}
            \alakohta{$k(49x^2-7x+1)=0$}
            \alakohta{$k(7x^2-x\sqrt{7} +1)=0$}
=======
...
\begin{tehtava}
    ...
    \begin{alakohdat}
        ...
        \alakohta{Johda lauseke yleisen paraabelin $ax^2+bx+c$ huipun $x$- ja $y$-koordinaateille.}
    \end{alakohdat}
    \begin{vastaus}
        \begin{alakohdat}
            \alakohta{$x=\frac14$ ja $y=5\frac58$.}
            \alakohta{$x=-\frac{b}{2a}$ ja $y=c-\frac{b^2}{4a}$}
>>>>>>> 4d86018a892aedbac8a38f3199b2db46cdfc8254
        \end{alakohdat}
    \end{vastaus}
\end{tehtava}

...
\begin{tehtava}
        \alakohta{Antero pitää hauskaa keksimällä luvun mielikuvituksessaan. Hän kirjoittaa
...
\begin{tehtava}
        \alakohta{Kun eräs luku kerrotaan kolmella, ja siihen sen jälkeen lisätään viisi, saadaan tulokseksi puolet alkuperäisestä luvusta.

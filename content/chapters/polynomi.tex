...
Esimerkiksi muuttujan $x$ lausekkeet 
\[ \frac{2}{x} \quad \text{ ja } \quad \sqrt{x}+2 \]  \emph{eivät ole} polynomeja.

% sillä niissä esiintyy potensseja, jotka eivät ole luonnollisia lukuja:
%\[
%\frac{2}{x} = 2x^{-1} \text{ ja } \sqrt{x}+2 = x^{\frac{1}{2}}+2.
%\]
...
Yhden termin polynomeja kutsutaan \termi{monomi}{monomeiksi}, kahden termin polynomeja \termi{binomi}{binomeiksi} ja kolmen termin polynomeja \termi{trinomi}{trinomeiksi} ja niin edelleen.
...
miinusmerkki, tulee musitaa vaihtaa termien merkin sulkuja avattaessa.
...
% ei avointa tehtävää ensimmäiseksi tehtäväksi    
    \begin{tabular}{|c|c|c|c|c|}
                                                                                           \hline
polynomi     & \begin{sideways}\begin{minipage}{3.5cm}termien\\lukumäärä\end{minipage}\end{sideways}%
& \begin{sideways}\begin{minipage}{3.5cm}korkeimman asteen\\termin kerroin\end{minipage}\end{sideways}%

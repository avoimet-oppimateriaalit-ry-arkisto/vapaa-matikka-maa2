...
Termin $t^4$ kerroin on $1$, termin $-t^3$ kerroin on $-1$, termin $(-\frac{1}{2})t^2$ kerroin on $-\frac{1}{2}$, ja vakiotermin kerroin on vakio itse eli $-9001$.
	...
	$t^4+(-t^3)+(-\frac{1}{2})t^2+(-8)$ \\
	$t^4$, $-t^3$, $(-\frac{1}{2})t^2$ ja $-8$ \\
	$1$, $-1$, $-\frac{1}{2}$ ja $-8$

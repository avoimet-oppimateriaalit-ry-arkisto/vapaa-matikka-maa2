...
\begin{tehtava}
    ...
    \begin{alakohdat}
        \alakohta{polynomin $P(x)$ arvo, kun $x=2$}
        \alakohta{polynomin $Q(x)$ arvo, kun $x=1$}
        \alakohta{$P(-7)$}
        \alakohta{$Q(-4)$.}
    \end{alakohdat}
    \begin{vastaus}
        \begin{alakohdat}
            \alakohta{$9$} % 2^2 + 5 = 4 + 5 
            \alakohta{$0$} % 1^3 - 1
            \alakohta{$54$} % (-7)^2 + 5 = 49 + 5 
            \alakohta{$-65$} % (-4)^3 - 1 = -64 -1
        \end{alakohdat}
    \end{vastaus}
\end{tehtava}
...
\begin{tehtava}
    ...
    \begin{vastaus}
        \begin{alakohdat}
            \alakohta{$x^3+x^2-7x+5$} % x^2+3x+4 + x^3-10x+1
            \alakohta{$-x^3+x^2+13x+3$} % x^2+3x+4 -(x^3-10x+1) = x^2+3x+4 -x^3+10x-1
            \alakohta{$x^3-x^2-13x-3$} % 
            \alakohta{$33$} % 2*(3^2+3*3+4) +  2^3-10*2+1 = 2*(9+9+4)+8-20+1 =44-11 =33
        \end{alakohdat}
    \end{vastaus}
\end{tehtava}
...
\begin{tehtava}
    Sievennä
    \begin{alakohdat}
        \alakohta{$(x^2 - 2x + 1) + (-x^2 + x) $}
        \alakohta{$(3y^3 + 2y^2  + y) - (-y^2 + y)$}
        \alakohta{$(z^{10} - z^6 + z^2 + 1) + (z^{10} + 2z^8 - 3z^6)$.}
    \end{alakohdat}
    \begin{vastaus}
        \begin{alakohdat}
            \alakohta{$-x + 1$}
            \alakohta{$3y^3 + 3y^2$}
            \alakohta{$2z^{10} + 2z^8 - 4z^6 + z^2 + 1$}
        \end{alakohdat}
    \end{vastaus}
\end{tehtava}
...
\begin{tehtava}
	...
	\begin{alakohdat}
		\alakohta{$x+5-x$}
		\alakohta{$x^2+x-2x^2$}
		\alakohta{$4x^5+x^2-4-x^2$}
		\alakohta{$x^3+2x^5-x-3x^5+3x^2+5+x^5$}
		\alakohta{$x^4-2x^3+x-1+x^3-x^4+x^3$}
	\end{alakohdat}
...
\begin{tehtava}
	...
	\begin{alakohdat}
		\alakohta{$2x+x^3+1$}
		\alakohta{$x^2+2x+1$}
		\alakohta{$x+2x^3+1 - (x^3+x)$}
		\alakohta{$15+x^4+2x+x^3-x^4-14$}
	\end{alakohdat}
	\begin{vastaus}
		a) ja d)
	\end{vastaus}
...
\begin{tehtava}
	...
	\begin{alakohdat}
		\alakohta{$P(x)=(x^3-4x+5)+(-x^3+x^2+4x-2)$}
		\alakohta{$Q(x)=(2x^3+x^2-10x)-(3x^3-4x^2+5x)$}
	\end{alakohdat}
	
	\begin{vastaus}
		\begin{alakohdat}
			\alakohta{$P(x)=x^2+3$, $P(1)=-2$, $P(-1)=-2$ ja $P(3)=5$}
			\alakohta{$Q(x)=-x^3+5x^2-15x$, $Q(1)=-11$, $Q(-1)=-9$ ja $R(3)=-27$}
		\end{alakohdat}
	\end{vastaus}
\end{tehtava}
...
\begin{tehtava}
	...
	\begin{alakohdat}
		 \alakohta{polynomien P(x) ja Q(x) summa}
		 \alakohta{lukujen P(1) ja Q(-2) erotus}
	\end{alakohdat}
	
	\begin{vastaus}
		\begin{alakohdat}
			\alakohta{$-x^3+6x^2-12$}
			\alakohta{$-54$}
	\end{alakohdat}
	\end{vastaus}
\end{tehtava}
...
\begin{tehtava}
	...
	\begin{alakohdat}
		\alakohta{aste}
		\alakohta{termit}
		\alakohta{kolmannen asteen termi}
		\alakohta{vakiotermi}
	\end{alakohdat}
...
\begin{tehtava}
	...
	\begin{alakohdat}
		\alakohta{$x^2 + 3x - 5$}
		\alakohta{$100 + x$}
		\alakohta{$3x^3 + 90x^8 + 2x$}
		\alakohta{$12x^1 + 34x^2 + 56x^3 + 78x^5 + 90x^5$}
	\end{alakohdat}
...
\begin{tehtava}
	Sievennä polynomifunktiot ja laske funktioiden arvot muuttujan arvoilla $1$, $-1$ ja $3$.
	\begin{alakohdat}
		\alakohta{$R(x)=4(2x-4)+(-x^3+1)$}
		\alakohta{$S(x)=-(2x^2-x+8)+6(x^5-3x^2+1)-2(3x^5-10x^2)$}
	\end{alakohdat}
	\begin{vastaus}
		\begin{alakohdat}
			\alakohta{$R(x)=-x^3+8x-15$, $R(1)=-8$, $R(-1)=-6$ ja $R(3)=-18$}
			\alakohta{$S(x)=-2$, $S(1)=-2$, $S(-1)=-2$ ja $S(3)=-2$}
		\end{alakohdat}
	\end{vastaus}
\end{tehtava}

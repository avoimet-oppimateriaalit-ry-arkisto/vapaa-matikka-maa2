...
\begin{tehtava}
    ...
    \begin{vastaus}
        \begin{alakohdat}
            \alakohta{$x = 3 tai x = -1$}
            \alakohta{$x = -5 tai x = -1$}
            \alakohta{$x = -1 + \sqrt{2} tai x = -1 - \sqrt{2}$}
...
\begin{tehtava}
	...
	20 euron vuosittaisen hoitomaksun, joka vähennetään summasta koronlisäyksen jälkeen. Viljami laskee, että hän saisi $2,4\%$ lisäyksen
	pääomaan kahden vuoden aikana.
        \begin{alakohdat}
            \alakohta{Mikä on rahaston korkoprosentti?}
            \alakohta{Paljonko rahaa viljamin pitäisi sijoittaa, että hänen sijoituksensa kasvaisi yhteensä $5\%$ kahden vuoden aikana?}
        \end{alakohdat}
	\begin{vastaus}
		$x = dfrac{5+sqrt{4428025}}{2000} \approx 1.03181211580212$
		Vastaus: $3,18\%$
	\end{vastaus}
\end{tehtava}

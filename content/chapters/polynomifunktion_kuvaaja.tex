...
\begin{tehtava}
\begin{kuva}
	kuvaaja.pohja(-2,4,-2,8,5,nimiX="$x$",nimiY="$P(x)$",ruudukko=False)
	kuvaaja.piirra("x**2-4*x+3")
\end{kuva}
Kuvaaja esittää polynomifunktion $P$ kuvaajaa. Mitä on kuvaajan perusteella
\begin{alakohdat}
\alakohta{$P(-1)$}
\alakohta{$P(0)$}
\alakohta{$P(1)$}
...
\begin{tehtava}
    ...
    \begin{vastaus}
    	...
    	\alakohta{ \begin{kuvaajapohja}{0.4}{-4}{4}{-1}{11}
				\kuvaaja{3*x**2+4}{}{red}
			  \end{kuvaajapohja}}
		\alakohta{ \begin{kuvaajapohja}{0.4}{-4}{4}{-11}{1}
				\kuvaaja{2*x**2-10}{}{red}
			  \end{kuvaajapohja}}
		\alakohta{ \begin{kuvaajapohja}{0.4}{-3}{5}{-2}{6}
				\kuvaaja{x**2-x-1}{}{red}
			  \end{kuvaajapohja}}
		\end{alakohdat}
    \end{vastaus}

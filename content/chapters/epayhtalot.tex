...
\begin{tehtava}
    ...
    \begin{vastaus}
        \begin{alakohdat}
            \alakohta{$x \in ]-9,7]$}
            \alakohta{$c \in [5,\infty]$}
            \alakohta{$s \in [5,7\frac{1}{2}]$}
            \alakohta{$x \in ]1,5]$}
            \alakohta{$a \in ]-\infty,b[$ \quad tai \quad $b \in ]a, \infty[$}
        \end{alakohdat}
    \end{vastaus}
\end{tehtava}
...
Maalipurkki sisältää 10 litraa maalia. Maalin riittoisuus on noin $6~m^2/l$. Talon ulkoseinän korkeus on 4,5~m. Ulkoseinälle tulevat laudat on maalattava kahteen kertaan. Riittääkö maali, jos maalattavan seinän pituus on
	...
	\begin{vastaus}
		\begin{alakohdat}
			\alakohta{riittää ($22,5~m^2 < 30~m^2$)}
			\alakohta{ei riitä ($45~m^2 > 30~m^2$)}

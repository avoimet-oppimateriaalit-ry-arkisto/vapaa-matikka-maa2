...
\laatikko[Tulon nollasääntö]{
	\begin{description}
		\item[''$\Longrightarrow$''] Jos jokin tulon tekijöistä on $0$, tulo on $0$.
		\item[''$\Longleftarrow$''] Jos tulo on $0$, ainakin yksi tulon tekijöistä on $0$.
	\end{description}
}

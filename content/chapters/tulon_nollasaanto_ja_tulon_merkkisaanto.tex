...
Tulon merkkisäännöstä seuraa, että luvun neliö ei voi olla negatiivinen. (Koska kahden samanmerkkisen luvun tulo on positiivinen.) Lyhyemmin ilmaistuna $x^2 \geq 0$, eli reaaliluvun neliö on aina \termi{epänegatiivinen}{epänegatiivinen}.

...
\begin{tehtava}
	\begin{alakohdat}
%\alakohta{Näytä, että polynomiyhtälöt $(2t-1)^2=-2t+1$ ja ... ovat samat.}
...
Polynomin $Q$ muuttuja on $x$, ja polynomi voidaan esittää tulomuodossa $(ax-b)(bx-a)$, missä $a$ ja $b$ ovat reaalisia vakioita, joille pätee $0<a<b$.
	\begin{alakohdat}
	\alakohta{Muodosta ja sievennä lauseke, jolla voi laskea funktion nollakohtien välisen etäisyyden.}
	\alakohta{Miten nollakohtien etäisyys muuttuu, kun summa $a+b$ kasvaa $10$\,\%?}
	\end{alakohdat}
		\begin{vastaus}
	\begin{alakohdat}

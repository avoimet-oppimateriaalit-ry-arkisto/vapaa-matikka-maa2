...
Muokkaa yhtälöt normaalimuotoisiksi toisen asteen yhtälöiksi ja merkitse tarvittaessa määrittelyehto.
    \begin{alakohdat}
        \alakohta{$x=\frac{1}{x}$}
        \alakohta{$\frac{1}{x+1}=x$}
        \alakohta{$\frac{y+1}{y^2}=2$}
        \alakohta{$ \frac{1}{t}=1-\frac{1}{t+1}$.}
    \end{alakohdat}
    \begin{vastaus}
        \begin{alakohdat}
            \alakohta{$x^2-1=0, x\neq 0$}
            \alakohta{$x^2+x-1=0, x \neq -1$}
            \alakohta{$2y^2-y-1=0, y \neq 0 $}
            \alakohta{$t^2-t-1=0, t\neq0,-1 $}
        \end{alakohdat}
    \end{vastaus}
\end{tehtava}
...
\begin{tehtava}
    ...
    \begin{vastaus}
        \begin{alakohdat}
            ...
            \alakohta{Noin $105$\,cm:n korkeudella.}
        \end{alakohdat}
    \end{vastaus}
\end{tehtava}

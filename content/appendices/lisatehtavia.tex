...
\end{kuvaajapohja}
		...
		\alakohta{Millä muttujan $x$ arvoilla $P(x)>0$?}
...
jokaisesta täydestä tunnista. Vuokraamo B laskuttaa $11,50$ \euro ja $1,5$ jokaisesta
...
\begin{tehtava} 
Ratkaise epäyhtälö \\
$ax \geq 2x+a$ \\ parametrin $a$ kaikilla arvoilla.
    \begin{vastaus}
...
\subsection*{Vähän vaikeampia sekalaisia}

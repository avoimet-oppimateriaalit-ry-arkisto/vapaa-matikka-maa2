...
\begin{tehtava}
	Viljami sijoittaa 1000 \euro korkorahastoon, jossa korko lisätään pääomaan vuosittain. Rahasto perii aina koronmaksun yhteydessä
...
\begin{tehtava}
    ...
    $v = v_0 + at$, missä $x$ on kuljettu matka, $v_0$ alkunopeus, $v$ loppunopeus ja $t$ aika.
		\begin{alakohdat}
            \alakohta{Kivi heitetään suoraan alas Olympiastadionin tornista 
            (korkeus $72$ metriä) nopeudella $3,0$~m/s. Kuinka monen sekunnin kuluttua kivi osuu maahan? Putoamiskiihtyvyys on
            noin $10$~m/$\text{s}^2$}

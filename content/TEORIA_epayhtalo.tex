...
\begin{esimerkki}
\begin{alakohdat}
\alakohta{$a < b$ tarkoittaa samaa kuin $b > a$}
\alakohta{$a \leq b$ tarkoittaa samaa kuin $b \geq a$}.
\alakohta{Epäyhtälö $a < b$ pätee täsmälleen silloin, kun epäyhtälö $a \geq b$ ei päde.}
\end{alakohdat}
\end{esimerkki}
